...
// Selecciona la imagen de TikTok y el div que la contiene
const tiktokImage = document.querySelector('.tiktok');
const tiktokDiv = document.querySelector('.tk');

// Agrega un event listener para cuando el cursor se posiciona sobre la imagen
tiktokImage.addEventListener('mouseover', function() {
    tiktokDiv.style.backgroundColor = '#FFD700'; // Cambia el fondo a amarillo mostaza
});

// Agrega un event listener para cuando el cursor sale de la imagen
tiktokImage.addEventListener('mouseout', function() {
    tiktokDiv.style.backgroundColor = ''; // Restaura el fondo original
});
